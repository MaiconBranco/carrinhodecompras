...
function setList(list){
	var table = '<thead><tr><td>Descrição</td><td>Quantia</td><td>Valor</td><td>Ação</td></tr></thead><tbody>';
	for(var key in list){
...
function validation(){
	...
	if(desc === ""){
		errors += '<p>Fill out Descrição</p>';
	}
	if(amount === ""){
		errors += '<p>Fill out a Quantidade</p>';
	}else if(amount != parseInt(amount)){
		errors += '<p>Fill out a valor válido</p>';
	}
	if(value === ""){
		errors += '<p>Fill out a Valor</p>';
